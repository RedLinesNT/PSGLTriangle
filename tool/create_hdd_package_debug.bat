...
echo Creating HDD package for "PSGLTriangle" (Debug)...

setlocal 

set PackageFileName=PSGLTriangleDebug.pkg
...
:: cacacopy ..\bin\PS3_Debug\PSGLTriangle.self PSGLTriangle.self

:: Un-(Fake-Signed) SELF it
"%SCE_PS3_ROOT%/host-win32/bin/unfself" ..\bin\PS3_Debug\PSGLTriangle.self ..\bin\PS3_Debug\PSGLTriangle.elf

:: Create EBOOT
"%SCE_PS3_ROOT%/host-win32/bin/make_fself_npdrm" ..\bin\PS3_Debug\PSGLTriangle.elf ..\bin\working\USRDIR\EBOOT.BIN
